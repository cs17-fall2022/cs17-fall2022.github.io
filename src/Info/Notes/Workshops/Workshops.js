...
const workshops = [
	{
		number: 1, title: "Learning CS and Fun with DrRacket", outDate: "Sept. 9-10", active: false,
		links: [
	...
	{
		number: 10, title: "Rackette Concept Review!", outDate: "Nov. 4-5", active: false,
		links: [
			{ icon: <FaFilePowerpoint />, link: "", label: "Slides" },
		]
	},
	{
		number: 11, title: "Analysis", outDate: "Nov. 17-18", active: false,
		links: [
			{ icon: <FaFilePowerpoint />, link: "", label: "Slides" },
		]
	},
	{
		number: 12, title: "Final Review Workshop", outDate: "Dec. 2-3", active: false,
		links: [
			// { icon: <FaFilePowerpoint />, link: "", label: "Slides" },
